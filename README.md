...
[![Build Status](https://github.com/vadimkozak/centrifuge/v1/workflows/build/badge.svg?branch=master)](https://github.com/vadimkozak/centrifuge/v1/actions)
...
[![GoDoc](https://pkg.go.dev/badge/centrifugal/centrifuge)](https://pkg.go.dev/github.com/vadimkozak/centrifuge/v1)

**This library has no v1 release yet, API still evolves. Use with strict versioning.** At this moment patch version updates only have backwards compatible changes and fixes, minor version updates can have backwards-incompatible API changes. See [v1.0.0 milestone](https://github.com/vadimkozak/centrifuge/v1/milestone/1). Master branch can have unreleased code.
...
* [centrifuge-js](https://github.com/vadimkozak/centrifuge/v1-js) – for a browser, NodeJS and React Native
* [centrifuge-go](https://github.com/vadimkozak/centrifuge/v1-go) - for Go language
* [centrifuge-mobile](https://github.com/vadimkozak/centrifuge/v1-mobile) - for iOS/Android with `centrifuge-go` as basis and [gomobile](https://github.com/golang/mobile)
* [centrifuge-dart](https://github.com/vadimkozak/centrifuge/v1-dart) - for Dart and Flutter
* [centrifuge-swift](https://github.com/vadimkozak/centrifuge/v1-swift) – for native iOS development
* [centrifuge-java](https://github.com/vadimkozak/centrifuge/v1-java) – for native Android development and general Java

See [Documentation](https://pkg.go.dev/github.com/vadimkozak/centrifuge/v1) and [examples](https://github.com/vadimkozak/centrifuge/v1/tree/master/_examples). You can also consider [Centrifugo server documentation](https://centrifugal.github.io/centrifugo/) as extra doc for this package (because it's built on top of Centrifuge library).
...
```bash
go get github.com/vadimkozak/centrifuge/v1
```
...
* Client initiated request handlers can be processed asynchronously in goroutines to manage operation concurrency. This is achieved using callback functions. See [concurrency](https://github.com/vadimkozak/centrifuge/v1/tree/master/_examples/concurrency) example for more details.
